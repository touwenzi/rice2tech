...
--
-- Host: localhost:3306
-- Generation Time: 2017-06-08 21:55:38
-- 服务器版本： 5.7.15-1
...
CREATE TABLE `setup`.`tp_setting` ( `title` VARCHAR(20) NULL ) ENGINE = MyISAM DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `tp_comment`
  MODIFY `cmid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
